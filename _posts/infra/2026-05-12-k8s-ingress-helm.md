...
시리즈의 마지막 편에서는 이 두 가지를 다룹니다: 외부 트래픽을 일관되게 라우팅하는 **Ingress**, 그리고 매니페스트를 패키징하는 **Helm**.
...
하지만 이 7편의 개념을 잡고 있으면, 새로운 주제를 만났을 때 "이건 어디에 해당하는 이야기인가" 를 잡아낼 수 있습니다. 이 시리즈가 남기고 싶었던 것도 그 기준점입니다.
