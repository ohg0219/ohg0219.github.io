...
AI 페어 프로그래밍을 일정 기간 써 본 사람이라면 익숙한 풍경이 있습니다.
...
기억이 없으니 절차도 없습니다. 어제의 결정이 오늘로 이어지지 않고, "설계대로 짰는가?" 를 객관적으로 확인할 방법도 없습니다. 단발 작업이라면 이래도 됩니다. 그런데 **여러 사이클을 누적해 가는 실제 제품 개발**에서는 흔적이 안 남는다는 게 결정적인 약점입니다.

Claude Code 의 PDCA Skill 은 이 문제를 정면으로 다룹니다. 이번 글은 이 스킬의 구조를 뜯어보고, 어떤 발상이 그 안에 들어 있는지 정리한 기록입니다.
...
겉으로 보이는 액션 표보다, **안쪽 설계** 가 더 재미있습니다.
...
## Before / After — "AI 와 일한다" 의 의미가 바뀐다
...
물론 만능은 아닙니다. 도입 전에 두 가지를 확인하는 게 좋습니다.
